  ...
  public render() {
    return (
      <div className="jumbotron jumbotron-fluid">
          ...
          <p className="lead">Access credible, timely information from parents who have helped their children navigate
            <p> the college admissions process and gain admissions to top universities.</p></p>
