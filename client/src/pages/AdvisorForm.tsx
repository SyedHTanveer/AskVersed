...
export default class Form extends React.Component<{}, any>{
  ...
  public render() 
{  	return this.state.questions[2].map( (obj: any)=> 
  		{
  			const question = <p key={obj.question}>{obj.question}</p>
  			let field;
	  		switch(obj.type){
	  			case 'text':
